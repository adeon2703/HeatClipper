...
So firstly you need to download [python](https://www.python.org/downloads/). Secondly you have to download all files from [github]([LINK]). And than insert your data to builder
